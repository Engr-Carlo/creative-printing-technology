...
const RAW_MATERIAL_OPTIONS = [
  ...
  { value: "NOT_SUFFICIENT", label: "Not Sufficient", color: "bg-yellow-100 text-yellow-800 border-yellow-300" },
  { value: "RELEASE_TO_PRODUCTION", label: "Release to Production", color: "bg-blue-100 text-blue-800 border-blue-300" },
