    ...
    <div className="min-h-full bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-primary to-orange-600 text-white px-5 py-5">
        <div className="flex items-start justify-between mb-4">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-orange-100">Item Management</p>
            <h1 className="text-xl font-black mt-0.5 flex items-center gap-2">
              <FolderOpen className="w-5 h-5" />
              Items Workspace
            </h1>
            <p className="text-xs text-orange-100 mt-0.5">Create, search, filter and manage all production jobs</p>
          </div>
          <QuickGenerateButton />
        </div>
        ...
        <div className="grid grid-cols-4 gap-2">
          {[
            { label: "Pending",     value: pending,    num: "text-yellow-200", bg: "bg-yellow-500/20 border-yellow-400/30" },
            { label: "In Progress", value: inProgress, num: "text-white",      bg: "bg-white/10     border-white/20"       },
            { label: "Completed",   value: completed,  num: "text-green-200",  bg: "bg-green-500/20  border-green-400/30"  },
            { label: "Rejected",    value: rejected,   num: "text-red-200",    bg: "bg-red-500/20    border-red-400/30"    },
          ].map((s) => (
